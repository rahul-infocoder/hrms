...
<h3 class="page-title"> Add Bonus <small>Add Bonus</small> </h3>
  ...
  <div class="span12"> 
    ...
    <div class="portlet box light-grey">
      <div class="portlet-title">
        <h4><i class="icon-globe"></i>Add Bonus</h4>
        <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#portlet-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
      </div>
      <div class="portlet-body">
      <!-- BEGIN FORM-->
              <?php echo form_open('admin/savebonus/',array('id'=>'form_est', 'autocomplete' => 'off', 'class' => 'form-horizontal form-bordered')); ?>
                ...
                <div class="control-group">
                  <label class="control-label" >Bonus (Rupees)</label>
                  <div class="controls">
