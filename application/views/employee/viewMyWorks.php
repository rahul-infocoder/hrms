  ...
  <div class="span12"> 
    ...
    <div class="portlet box light-grey">
      <div class="portlet-title">
        <h4><i class="icon-globe"></i>My Report</h4>
        ...
        <table class="table table-striped table-bordered table-hover" id="msgTable">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td><?php echo $wlist->contact_name; ?></td>
...
echo anchor_popup('admin/reporPopup/'.$wlist->Wid, ' Read More', $atts);
...
<script>
		jQuery(document).ready(function() {			
			...
			var site = '<?php echo site_url('employees/viewMyReport'); ?>';
