  ...
  <div class="navbar-inner">
	...
	?>
      ...
      <ul class="nav pull-right">
		...
		$noteNo = $CI->Notificationmodel->unReadNote();
		$noteList =  $CI->Notificationmodel->noteList();
		 ?> 
		...
		$unReadNoMsg =$CI->Messagemodel->unReadMsg(); ?>
        <li class="dropdown" id="header_inbox_bar"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-envelope-alt"></i> <?php if($unReadNoMsg > 0){ ?> <span class="badge"><?php echo $unReadNoMsg; ?></span> <?php } ?> </a>
          <ul class="dropdown-menu extended inbox">
            ...
            <?php
			$unReadList =$CI->Messagemodel->unReadList(); ?>
			...
			?>
            <li> <a href="<?php echo site_url() ?>/message/viewInbox/<?php echo $row->msgId; ?>"> <span class="photo"><img src="<?php echo $msgImgUrl ?>" alt="" /></span> <span class="subject"> <span class="from"><?php echo substr($CI->Messagemodel->FindName($row->msg_from),0,7); ?></span> <span class="time"><?php echo time_elapsed_string($row->date); ?></span> </span> <span class="message"> 
        ...
        <?php 
		$noTask = $CI->Notificationmodel->task(); 
		$taskDetail = $CI->Notificationmodel->taskDetail();
		?>
