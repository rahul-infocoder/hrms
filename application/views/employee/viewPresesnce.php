        ...
        <table class="table table-striped table-bordered table-hover" id="msgTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="hidden-480"><?php if($clist->signouttime == null){ echo "?";}else {  echo date('d/m/Y h:i:s A', $clist->signouttime);} ?></td>
              <td>
              <?php
              $diff = ($clist->signouttime-$clist->signintime); 
...
<script>
		jQuery(document).ready(function() {			
			...
			var site = '<?php echo site_url('employees/viewAllPresence'); ?>';
