...
<h3 class="page-title"> Sent Message <small>Sent Message</small> </h3>
  ...
  <div class="span12"> 
    ...
    <div class="portlet box blue">
      <div class="portlet-title">
        <h4><i class="icon-globe"></i>Sent Message</h4>
        <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#portlet-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
      </div>
      <div class="portlet-body">
      <label class="btn mini  blue"><?php echo date('d-m-Y h:i:s A',$sent->date); ?></label>
      <!--To-->
     <div style="padding-top:20px;">
     <label class="btn  blue"> To: </label>
     <?php
	  $to = explode(',',$sent->msg_to);
	  
	  
	  for($i=0; $i<count($to); $i++)
	  {
	     echo '<label class="btn mini  green">'.Messagemodel::FindName($to[$i]).'</label>';
		 if($i != (count($to)-1) )
		 {
		  echo ' ';	 
		 }	  
     ...
     <label class="btn mini green"> <?php echo  $sent->subject; ?> </label>
    ...
    <div style="padding-top:20px; display:inline-block">
     ...
     <?php if($sent->attachment != '' || $sent->attachment !=null ){
		$arr = explode('<@@>',$sent->attachment);
