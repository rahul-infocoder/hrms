  ...
  <div class="span12"> 
    ...
    <div class="portlet box blue">
      <div class="portlet-title">
        ...
        <div class="tools"> 
         <a href="<?php echo site_url('admin/holiday'); ?>"  style="color:#fff;"><i class="icon-plus-sign "></i></a>  </div>
      </div>
      <div class="portlet-body">
      ...
      <table class="table table-striped table-bordered table-hover" id="msgTable">
          ...
          <tbody> 
           <?php foreach($list->result() as $row):?>  
            ...
            <td><?php echo anchor('admin/deleteHoliday/'.$row->id,'Delete'); ?></td>
            </tr>
...
<script>
		jQuery(document).ready(function() {			
			...
			location.href='<?php echo site_url('admin/viewHoliday') ?>'+'/'+$(this).val();
