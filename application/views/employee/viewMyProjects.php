        ...
        <table class="table table-striped table-bordered table-hover" id="example">
          <thead>
            <tr>
              ...
              <th class="hidden-480">Assign Date</th>
              <th class="hidden-480">Admin Comments</th>
              <!-- <th class="hidden-480">Action</th> -->
            </tr>
          </thead>
          <tbody>
            <?php foreach($pdata as $plist){ ?>
            <tr >
              
              <td style="text-transform: capitalize; "> <?php echo $plist['title']; ?> </td>             
              <td class="hidden-480"><?php echo $plist['deadLine'] !='0'?date('d-m-Y',$plist['deadLine']):'No date';  ?></td>
              <td class="hidden-480"><?php echo $plist['esdatefrom'] !='0'?date('d-m-Y',$plist['esdatefrom']):'No date'; ?></td>
              <td class="hidden-480"><?php echo $plist['remarks'];?><span style="float: right;"><button type="button" class="btn btn-primary "><a href="#">open</a></button></td>
              <!-- <td class="hidden-480">
